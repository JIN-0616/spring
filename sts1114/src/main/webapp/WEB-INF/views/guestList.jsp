...
<style type="text/css">
	* {	font-size: 16pt;font-weight: bold;font-family: Comic Sans MS;}
	...
	a:hover {font-size: 16pt;font-weight: bold;color: green;text-decoration: underline;}
...
<body>
	...
	<table width=900 border=1 cellspacing=0>
		<tr align="right">
			<td colspan=5>레코드갯수: &nbsp;&nbsp;${Stotal}/${Gtotal}</td>
		</tr>
			...
			<td colspan="5">
				<form name="myform" action="list.do">
					검색 : <select name="keyfield" onchange="changeclear();">
						<option value="all" <c:if test="${skey eq 'all'}">selected</c:if>>전체검색</option>
						...
						<option value="" selected>내용검색</option>
					</select>
